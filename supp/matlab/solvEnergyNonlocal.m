function [E_transfer,A,B,C,A_Y,A_nl,B_nl,C_nl,V1,K1,VY1,KY1] = solvEnergyNonlocal(pqrFile,srfFile,E_0,E_inf, ...
...
[A_nl,B_nl,C_nl,V1,K1,VY1,KY1] = generate_nonlocal_matrices(A, B, C, A_Y, areas,...
																E_0, E_inf, E_omega, ...
																E_sigma);

E_transfer = 0.239005 * (Na/1000) * (q^2/E_0) * 1e10 *...
