function [A,B,C,V,K,VY,KY] = generate_nonlocal_matrices(surfaceToSurfaceOperators,...
...
B = [Bmat1+Bmat2; 
	  ...
	  0 * chargeToSurfaceOperators.DirichletTrace];
D = I * chargeToSurfaceOperators.DirichletTrace;%
Ne = I * chargeToSurfaceOperators.NeumannTrace;
